...
from pddm.classic_pollicy.base_programing.PID_vreacher import PID

class VReacher_PID(object):
    ...
    def __init__(self, env, dyn_models, reward_func, rand_policy, use_ground_truth_dynamics,
        ...
        self.pid = PID(P=5., I=0., D=0.05, delta_time=self.env.env.env.dt, target_pos=0.)
    ...
    def get_action(self, step_number, curr_state_K, actions_taken_so_far,
        ...
        state = curr_state_K[0]
        best_action,_= self.pid.update(state)
