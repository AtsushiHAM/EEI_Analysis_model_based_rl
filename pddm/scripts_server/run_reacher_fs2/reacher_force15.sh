...
python ~/Documents/pddm/scripts/train1.py --config ~/Documents/pddm/config_server/config_reacher_fs2/reacher_force15_mppi.txt --output_dir /data/atsushi_data/output/re_force --use_gpu --gpu_frac=0.1 --control_delta 1 --reward_type st
