...
python ~/Documents/pddm/scripts/train.py --config ~/Documents/pddm/config_server/config_vreacher_fs2/vreacher_force11_mppi.txt --output_dir /data/atsushi_data/output/vre_force --use_gpu --gpu_frac=0.1 --control_delta 1 --reward_type st
