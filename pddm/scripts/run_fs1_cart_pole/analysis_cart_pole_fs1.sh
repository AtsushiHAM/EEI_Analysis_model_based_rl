...
###job path ##########
##############################
job_path_mppi="/media/ashrising/2619822E48B88AD8/pddm/analysis_data/cp/2020-12-16/control_delta_1/Controller_mppi_Horizon20_Can1000_beta0.9/Iter30_Rollout10_Step500/ensemble3_num2_depth250/pddm_cart_pole-v0/2020-12-16_22-47-51/cart_pole"
...
job_path_mppi_f10="/media/ashrising/2619822E48B88AD8/pddm/analysis_data/cp/2020-12-16/control_delta_1/Controller_mppi_Horizon20_Can1000_beta0.9/Iter30_Rollout10_Step500/ensemble3_num2_depth250/pddm_cart_pole-v10/2020-12-16_22-49-12/cart_pole"
...
job_path_mppi_f14="/media/ashrising/2619822E48B88AD8/pddm/analysis_data/cp/2020-12-16/control_delta_1/Controller_mppi_Horizon20_Can1000_beta0.9/Iter30_Rollout10_Step500/ensemble3_num2_depth250/pddm_cart_pole-v14/2020-12-16_22-49-48/cart_pole"
...
job_path_mppi_f214="/media/ashrising/2619822E48B88AD8/pddm/analysis_data/cp/2020-12-16/control_delta_1/Controller_mppi_Horizon20_Can1000_beta0.9/Iter30_Rollout10_Step500/ensemble3_num2_depth250/pddm_cart_pole-v214/2020-12-16_22-51-01/cart_pole"
...
job_path_pid="/media/ashrising/2619822E48B88AD8/pddm/analysis_data/cp/2020-12-17/control_delta_1/Controller_cp_pid_Horizon20_Can4000_beta0.9/Iter1_Rollout1_Step500/ensemble3_num2_depth250/pddm_cart_pole-v0/2020-12-17_13-57-20/cart_pole"
...
do
  ...
  ### 1 torque sensor####
  #python ~/Documents/pddm-master/pddm/scripts/eval_iteration.py --job_path $job_path_mppi_f10 --running_times $running_times --iter_num $iter_num --execute_sideRollouts --control_delta $control_delta --use_gpu
  ...
  ### 2 torque sensor####
  #python ~/Documents/pddm-master/pddm/scripts/eval_iteration.py --job_path $job_path_mppi_f14 --running_times $running_times --iter_num $iter_num --execute_sideRollouts --control_delta $control_delta --use_gpu
  ...
  ### 3 torque sensor####
  #python ~/Documents/pddm-master/pddm/scripts/eval_iteration.py --job_path $job_path_mppi_f214 --running_times $running_times --iter_num $iter_num --execute_sideRollouts --control_delta $control_delta --use_gpu
  ...
  ### pid ####
  #python ~/Documents/pddm-master/pddm/scripts/eval_iteration.py --job_path $job_path_pid --running_times $running_times --iter_num $iter_num_pid  --control_delta $control_delta
done
...
python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_mppi_f10 $job_path_mppi_f14 $job_path_mppi_f214 $job_path_mppi $job_path_pid  --save_dir $job_path_pid  --data_type rewards --save_num mppi_delta1_all
#python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_mppi_f10 $job_path_mppi_f14 $job_path_mppi_f214 $job_path_mppi $job_path_pid  --save_dir $job_path_pid  --data_type eei --save_num mppi_delta1_all
#python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_mppi_f10 $job_path_mppi_f14 $job_path_mppi_f214 $job_path_mppi $job_path_pid  --save_dir $job_path_pid  --data_type ene --save_num mppi_delta1_all
#python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_mppi_f10 $job_path_mppi_f14 $job_path_mppi_f214 $job_path_mppi $job_path_pid  --save_dir $job_path_pid  --data_type er --save_num mppi_delta1_all

#python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_rand_f10 $job_path_rand_f14 $job_path_rand_f214 $job_path_rand $job_path_pid  --save_dir $job_path_pid  --data_type rewards --save_num rand_delta1_all
#python ~/Documents/pddm-master/pddm/statstics_anlysis/box_plot_kai_test.py -j $job_path_rand_f10 $job_path_rand_f14 $job_path_rand_f214 $job_path_rand $job_path_pid  --save_dir $job_path_pid  --data_type eei --save_num rand_delta1_all
