...
#python ~/Documents/pddm/scripts/train.py --config ~/Documents/pddm/config_reacher_fs2/vreacher_mppi_ngr.txt --output_dir ~/Documents/pddm/output/re --use_gpu --gpu_frac=0.15 --control_delta 1
...
#python ~/Documents/pddm-master/pddm/scripts/train.py --config ~/Documents/pddm-master/pddm/config_reacher_fs2/vreacher_rand_ngr.txt --output_dir ~/Documents/pddm-master/pddm/output/re --use_gpu --gpu_frac=0.15 --control_delta 1 --reward_type st
