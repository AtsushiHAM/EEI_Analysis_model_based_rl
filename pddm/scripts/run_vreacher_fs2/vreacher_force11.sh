...
python ~/Documents/pddm/scripts/train.py --config ~/Documents/pddm/config_server/config_reacher_fs2/reacher_force12_mppi.txt --output_dir ~/Documents/pddm/output/re_force --use_gpu --gpu_frac=0.1 --control_delta 1 --reward_type st
...
python ~/Documents/pddm/scripts/train.py --config ~/Documents/pddm/config_server/config_reacher_fs2/reacher_force12_rand.txt --output_dir ~/Documents/pddm/output/re_force --use_gpu --gpu_frac=0.1 --control_delta 1 --reward_type st