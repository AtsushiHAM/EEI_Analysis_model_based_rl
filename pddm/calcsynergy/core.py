...
from synergy_utils.utils import reshape_into_spt_shape,reshape_into_spatial_shape,reshape_into_temporal_shape
...
def calculate_synergy(torque_npy,synergy_type="spatiotemporal", start_index=300,windows=400):
    """
    ...
    :param torque_npy: The time series to extract synergy from.
    ...
    if synergy_type=='spatiotemporal':
        ...
        max_pca_components=X.shape[0]+1
    ...
    for num_vec_to_keep_ in range(1,max_pca_components):
    ...
    surface_area_single_line=integrate.simps(rsq_single_list,range(1,max_pca_components))

    return R2_list_single_line,surface_area_single_line

if __name__ == '__main__':
    import matplotlib.pyplot as plt
    from synergy_utils.utils import R2
    ...
    for i in range(10):
        ...
        R2_list_single_line, surface_area_single_line = calculate_synergy(torque_npy,synergy_type="spatiotemporal")#"spatial""temporal""spatiotemporal"
